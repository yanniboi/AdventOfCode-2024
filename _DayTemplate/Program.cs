...
public class Program
{
    ...
    public static int RunExample(int step)
    {
        ...
        var filePath = Path.Combine(AppContext.BaseDirectory, "day-<DAY>/example/input.txt");
        return Run(filePath);
    }
    ...
    public static int RunChallenge(int step)
    {
        ...
        var filePath = Path.Combine(AppContext.BaseDirectory, "day-<DAY>/challenge/input.txt");
        return Run(filePath);
    }
